...
router.post("/login/forgot-password", async (req, res) => {
  try {
    ...
    if (userFromDB[0] === undefined) {
      ...
      const link = `https://localhost:3000/reset-password/${userFromDB[0].username}/${token}`;
      // const link = `https://to-do-app-pradeep.netlify.app/reset-password/${userFromDB[0].username}/${token}`;
